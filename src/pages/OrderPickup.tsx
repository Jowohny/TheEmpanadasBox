	...
	return (
		<div className="min-w-screen min-h-screen">
			...
			>
				...
				<div className="absolute top-1/2 left-0 -translate-y-1/2 ml-12">
					<div className="inline-block font-mono font-bold uppercase text-xs tracking-widest bg-red-400/40 text-red-900 rounded-full py-1 px-4 mb-8">
						The World Tour Experience
					</div>
					<div className="text-9xl font-bold tracking-tight leading-[0.9]">
			...
			<div className="bg-[#faf7f2] px-6 py-16">
				<div className="mx-auto max-w-[90rem]">
					<div className="mb-14 text-center">
						<p className="mb-3 font-mono text-xs font-black uppercase tracking-[0.3em] text-[#fec32f]">
							Our Locations
						</p>
						<h2 className="mb-3 font-inter text-6xl font-black tracking-tight text-[#242424]">
							Where are we heading today?
						</h2>
						<p className="text-[#64605b] text-xl font-light tracking-wide">
			...
			<div className="relative flex min-h-[38rem] items-center justify-between overflow-hidden border-b border-[#e2d8ca] bg-[#faf7f2] px-20 py-16">
				...
				<div className="relative z-10 ml-6 max-w-[42rem]">
					...
					<div className="flex gap-4">
						<button
							...
							className="cursor-pointer rounded-full bg-[#fec32f] px-8 py-4 font-mono text-xs font-black uppercase tracking-[0.16em] text-[#765600] shadow-md transition-colors duration-200 hover:bg-[#eeb11f]"
						>
							Check Stamp Balance
						</button>
						<button
							onClick={() => navigate('/Rewards')}
							className="cursor-pointer rounded-full border border-[#d4c9b8] px-8 py-4 font-mono text-xs font-black uppercase tracking-[0.16em] text-[#5f5a54] transition-colors duration-200 hover:border-[#fec32f] hover:text-[#242424]"
						>
							Learn More
						</button>
					</div>
			...
			<div className="relative border-b border-[#e2d8ca] bg-[#0d0c0b] px-20 py-16">
				<div className="absolute left-0 top-0 h-full w-3 bg-[#fec32f]" />
			...
			<div className="border-b border-[#e2d8ca] bg-[#faf7f2] px-20 py-16 text-center">
				<p className="mb-3 font-mono text-xs font-black uppercase tracking-[0.3em] text-[#fec32f]">
					Order Support
				</p>
