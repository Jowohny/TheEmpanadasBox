		...
		<div className="min-w-screen min-h-screen">
			...
			>
				...
				<div className="absolute top-1/2 left-0 -translate-y-1/2 ml-6 md:ml-8 lg:ml-12 max-w-[92vw]">
					<div className="inline-block font-mono font-bold uppercase text-[10px] md:text-xs tracking-widest bg-red-400/40 text-red-900 rounded-full py-1 px-3 md:px-4 mb-4 md:mb-8">
					...
					<div className="text-7xl md:text-8xl lg:text-9xl font-bold tracking-tight leading-[0.9]">
						...
						<h2 className="text-[#765600] mb-4 md:mb-6 lg:mb-8">Eat Up.</h2>
					</div>
					<p className="font-sans text-base md:text-2xl lg:text-3xl text-gray-600 tracking-wide font-medium">
			...
			<div className="bg-[#faf7f2] px-4 md:px-6 py-10 md:py-16">
				<div className="mx-auto max-w-[90rem]">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 mb-12 md:mb-20">
			...
			<div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-2 bg-[#0d0c0b] px-4 md:px-10 lg:px-20 py-4 md:py-5 border-y border-white/8">
			...
			<div className="relative flex flex-col lg:flex-row min-h-[38rem] items-center lg:justify-between overflow-hidden border-b border-[#e2d8ca] bg-[#faf7f2] px-6 md:px-12 lg:px-20 py-12 md:py-16 gap-10 lg:gap-0">
				...
				<div className="relative z-10 ml-4 md:ml-6 max-w-full lg:max-w-[42rem]">
					<p className="mb-3 md:mb-4 font-mono text-[10px] md:text-xs font-black uppercase tracking-[0.3em] text-[#fec32f]">
						Passport Rewards
					</p>
					<h2 className="mb-4 md:mb-5 font-inter text-4xl md:text-6xl lg:text-7xl font-black leading-[0.88] tracking-tight text-[#242424]">
						Don't Leave<br />Without Your<br />Stamps!
					</h2>
					<p className="mb-6 md:mb-8 max-w-md text-base md:text-lg font-light leading-relaxed text-[#64605b]">
					...
					<div className="mb-6 md:mb-9 grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
						{RewardsTiers.map(({ stamps, reward }) => (
							<div key={stamps} className="rounded-xl border border-[#e2d8ca] bg-white/60 text-center px-3 md:px-5 py-3 md:py-4">
				...
				<div className="relative z-10 mr-0 lg:mr-10 h-[60vw] w-[60vw] md:h-[24rem] md:w-[24rem] lg:h-[33rem] lg:w-[33rem] overflow-hidden rounded-full border-4 md:border-8 border-[#faf7f2] shadow-[0_28px_60px_rgba(26,18,9,0.18)]">
					<img
			...
			<div className="relative border-b border-[#e2d8ca] bg-[#0d0c0b] px-6 md:px-12 lg:px-20 py-12 md:py-16">
				...
				<div className="ml-4 md:ml-6">
					...
					<h2 className="mb-8 md:mb-10 font-inter text-3xl md:text-4xl lg:text-5xl font-black tracking-tight text-[#faf7f2]">
						How to Heat Your Empanadas
					</h2>

					<div className="flex flex-col md:flex-row gap-4 md:gap-6">
						<div className="flex flex-1 flex-col justify-between rounded-2xl border border-white/8 bg-white/4 p-5 md:p-7">
							<div>
						...
						<div className="flex flex-1 flex-col justify-between rounded-2xl border border-red-900/60 bg-red-950/50 p-5 md:p-7">
							<div>
			...
			<div className="border-b border-[#e2d8ca] bg-[#faf7f2] px-6 md:px-12 lg:px-20 py-12 md:py-16 text-center">
				...
				<h2 className="mb-8 md:mb-10 font-inter text-3xl md:text-4xl lg:text-5xl font-black tracking-tight text-[#242424]">
					Need Help?
				</h2>
				...
				<div className="mx-auto grid max-w-3xl grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
					<div>
