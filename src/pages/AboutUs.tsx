...
const AboutUs = () => {
	...
	useGSAP(() => {
		...
		gsap.to("[data-hero-copy]", {
			yPercent: -25, autoAlpha: 0, ease: "none",
			scrollTrigger: { trigger: "[data-hero]", start: "top top", end: "bottom 45%", scrub: true },
		})
		...
		gsap.utils.toArray<HTMLElement>("[data-line]").forEach(el => {
			gsap.fromTo(el,
				...
				{ scaleY: 1, transformOrigin: "top center", ease: "none",
					scrollTrigger: { trigger: el, start: "top 80%", end: "bottom 65%", scrub: true } },
			)
		})
		...
		gsap.utils.toArray<HTMLElement>("[data-float]").forEach((el, i) => {
			gsap.from(el, {
				scale: 0.4, autoAlpha: 0, duration: 0.8, ease: "back.out(1.6)", delay: i * 0.1,
				scrollTrigger: { trigger: el, start: "top 92%", once: true },
			})
			gsap.to(el, {
				y: gsap.utils.random(-20, -8), rotation: gsap.utils.random(-5, 5),
				duration: gsap.utils.random(2.6, 4.4), ease: "sine.inOut", repeat: -1, yoyo: true, delay: i * 0.25,
			})
			gsap.fromTo(el,
				{ yPercent: -8 - i * 4 },
		...
		gsap.fromTo("[data-word]",
			...
			{ xPercent: 8, ease: "none",
				scrollTrigger: { trigger: "[data-word]", start: "top bottom", end: "bottom top", scrub: true } },
		)
	}, { scope: container })

	return (
		<div ref={container} className="min-w-screen min-h-screen -mt-[8.25rem] overflow-x-hidden bg-[#faf7f2]">
			<div data-hero className="relative flex items-center justify-center overflow-hidden">
				<img
					data-parallax
				...
				<div data-hero-copy className="absolute z-20 flex max-w-4xl flex-col items-center px-6 text-center">
					<div data-reveal className="mb-6 md:mb-8 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-3 md:px-4 py-2 backdrop-blur-md">
						<span className="font-mono text-[10px] md:text-xs font-black uppercase tracking-[0.22em] text-white">
							The Empanadas Box
						</span>
					</div>
					<h1 data-reveal className="mb-6 font-inter text-6xl sm:text-7xl md:text-8xl font-black uppercase leading-[0.85] tracking-wide text-white">
			...
			<div className="relative overflow-hidden bg-[#faf7f2] px-6 py-16 md:px-12 md:py-20 lg:px-20 lg:py-28">
				<div className="relative mx-auto max-w-[90rem] lg:flex lg:justify-end">
					...
					{/* ADD IMAGE HERE */}
					<img data-reveal src="" className="h-60 sm:h-80 w-full rounded-xl object-cover lg:h-[42rem] lg:w-[60%]" />
					<div className="relative -mt-10 mx-auto w-[92%] bg-white p-7 sm:p-10 shadow-[0_30px_70px_rgba(26,18,9,0.16)] lg:absolute lg:left-0 lg:top-1/2 lg:mx-0 lg:mt-0 lg:w-[46%] lg:-translate-y-1/2 lg:p-12">
						<div data-rule className="mb-6 h-[3px] w-14 bg-[#bf8000]" />
						<p data-reveal className="mb-3 font-mono text-[10px] md:text-xs font-black uppercase tracking-[0.3em] text-[#bf8000]">
							Insider
						</p>
						<h2 data-reveal className="font-inter text-4xl md:text-5xl lg:text-6xl font-black leading-[0.95] tracking-tight text-[#1a1209]">
							Who are we?
						</h2>
						<div data-reveal className="mt-6 space-y-5 text-base md:text-lg font-light leading-relaxed text-[#64605b]">
							<p>
			...
			<div className="relative overflow-hidden bg-white px-6 py-16 md:px-12 md:py-20 lg:px-20 lg:py-28">
				<div className="mx-auto max-w-[90rem]">
					<div className="mb-8 md:mb-4">
						...
						<h2 data-reveal className="font-inter text-4xl md:text-5xl lg:text-6xl font-black tracking-tight text-[#1a1209]">
							From a Pop-Up to Elm Street
						</h2>
					</div>

					<p data-reveal className="max-w-2xl text-base md:text-lg font-light leading-relaxed text-[#64605b]">
					...
					<div className="relative mt-12 md:mt-16">
						<div data-line className="absolute left-[11px] top-4 bottom-4 border-l-[3px] border-dotted border-[#bf8000]/40 md:left-[13px]" />

						<ol className="flex flex-col gap-12 md:gap-16">
							{Milestones.map((m) => (
								<li key={m.marker} data-reveal className="relative pl-12 md:pl-16">
									<span data-pin className="absolute left-0 top-0 bg-white pb-1">
									...
									<p data-reveal className="mt-3 max-w-2xl text-base md:text-lg font-light leading-relaxed text-[#64605b]">
										{m.body}
									</p>
								</li>
							))}
			...
			<div className="relative overflow-hidden bg-[#faf7f2] px-6 py-16 md:px-12 md:py-16 lg:px-20 lg:py-24">
				<div className="mx-auto max-w-[90rem]">
					...
					<div className="flex flex-col md:flex-row md:justify-center gap-12 md:gap-6 lg:gap-10">
						{Family.map((member, i) => (
							<div key={i} data-reveal className={`w-full md:w-1/3 ${i%2===1 ? 'md:mt-28' : 'md:mt-14'}`}>
								<div className="h-64 sm:h-88 md:h-[17rem] lg:h-[23rem] w-full overflow-hidden rounded-xl bg-[#ede5d8]">
									<img data-parallax src={member.picture} className="h-full w-full object-cover" />
								</div>
			...
			<div className="relative overflow-hidden bg-[#0d0c0b] px-6 py-20 md:px-12 md:py-28 lg:px-20 lg:py-40">
				<span data-word className="pointer-events-none absolute left-0 top-1/2 -translate-y-1/2 select-none font-inter text-[6rem] sm:text-[9rem] md:text-[13rem] lg:text-[17rem] font-black uppercase leading-none tracking-tighter text-white/[0.04]">
					Mission
				</span>
				<div className="relative mx-auto max-w-[90rem]">
					<div className="max-w-3xl text-left lg:ml-auto lg:text-right">
						<p data-reveal className="mb-4 md:mb-6 font-mono text-[10px] md:text-xs font-black uppercase tracking-[0.3em] text-[#fec32f]">
							What drives us
						</p>
						<h2 data-reveal className="mb-6 md:mb-8 font-inter text-4xl md:text-5xl font-black uppercase tracking-tight text-[#faf7f2]">
							Mission
						</h2>
						<p data-reveal className="text-lg md:text-xl font-light leading-snug text-white/70">
			...
			<div className="relative overflow-hidden bg-[#faf7f2] lg:min-h-[44rem]">
				...
				<div className="relative mx-auto flex max-w-[90rem] items-center px-2 py-14 md:px-4 md:py-20 lg:min-h-[44rem] lg:py-0">
					<div className="w-full lg:w-[50%]">
						...
						<div data-rule className="my-6 md:my-8 h-[2px] w-12 bg-[#bf8000]" />
						<p data-reveal className="max-w-xl text-base md:text-lg font-light leading-relaxed text-[#64605b]">
			...
			<div className="relative overflow-hidden bg-[#faf7f2] px-6 py-16 md:px-12 md:py-20 lg:px-20 lg:py-28">
				<div className="mx-auto flex flex-col lg:flex-row lg:items-center gap-16 lg:gap-20 max-w-[90rem]">
					<div className="relative w-full lg:w-[52%]">
						...
						<img data-reveal src="" className="h-72 sm:h-96 w-full rounded-xl bg-[#ede5d8] object-cover lg:h-[38rem]" />
					...
					<div className="w-full lg:w-[40%]">
						...
						<div data-rule className="my-6 md:my-8 h-[2px] w-12 bg-[#bf8000]" />
						<p data-reveal className="text-base md:text-lg font-light leading-relaxed text-[#64605b]">
			...
			<div className="relative min-h-[38rem] overflow-hidden lg:min-h-[46rem]">
				...
				<div className="relative mx-auto flex min-h-[38rem] max-w-[90rem] items-center px-6 py-16 md:px-12 lg:min-h-[46rem] lg:px-20 lg:py-0">
					<div className="w-full lg:w-[56%]">
						...
						<h2 data-reveal className="font-inter text-4xl md:text-5xl lg:text-6xl font-black leading-[0.95] tracking-tight text-white">
							Catering
						</h2>
						<div data-rule className="my-6 md:my-8 h-[2px] w-12 bg-[#fec32f]" />
						<p data-reveal className="mb-8 max-w-2xl text-base md:text-lg font-light leading-relaxed text-white/85">
			...
			<div className="relative z-10 bg-white px-6 pt-16 pb-16 md:px-12 md:pt-20 lg:px-20 lg:pt-28">
				<div className="mx-auto flex max-w-[90rem] flex-col lg:flex-row lg:items-center gap-12 lg:gap-20">
					<div className="w-full lg:w-[42%]">
						...
						<div data-rule className="my-6 md:my-8 h-[2px] w-12 bg-[#bf8000]" />
						<p data-reveal className="mb-8 text-base md:text-lg font-light leading-relaxed text-[#64605b]">
